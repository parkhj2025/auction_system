 ...
 * - 디자인: bg-slate-100 + border-l-4 border-brand-600 + text-base + CheckCircle2 prefix
...
export function StickyPropertyBar({
  ...
  return (
    <div className="sticky top-0 z-10 border-b border-[var(--color-border)] border-l-4 border-l-brand-600 bg-slate-100 backdrop-blur-sm">

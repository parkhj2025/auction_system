...
const REVIEWS: Review[] = [
  ...
  { id: 6, label: "20대 첫 입찰", emoji: "✨", bg: "#DCFCE7", fg: "#27500A", quote1: "등기부는 직접 확인했지만 법원 방문은 부담스러웠어요.", quote2: "입찰만 맡기니 한결 가벼웠습니다.", meta: "1주 전" },
  ...
  { id: 17, label: "60대 첫 경매", emoji: "🤔", bg: "#F3F4F6", fg: "#444441", quote1: "처음 경매라 법원이 무서웠어요.", quote2: "공인중개사가 직접 들어가준다니 든든했습니다.", meta: "2개월 전" },

 ...
 * v10 정정: 30 cols × 40 rows = 1,200 cells (50×50 → 비용 ↓).
 * lg+ only (mobile = 부모 컴포넌트에서 hidden 처리). hover 시 green #00C853 색칠 / 0.3s ease-out.
 * import 변환: framer-motion → motion/react (motion v12.38.0). */

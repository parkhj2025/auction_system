...
/** 단계 5-4-1: Hero DominantStat + DropRateBar 다이어그램 통합.
 *  단계 5-2 의 −30% 칩 → DropRateBar (감정가 base bar + 최저가 fill bar + count-up) 으로 시각 보강.
...
// computeDropRate 는 DropRateBar 컴포넌트로 이동 (단계 5-4-1).
